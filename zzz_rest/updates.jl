...
for L in [16,32,64,96]
    ...
    xlabel = "MC time")
    display(image)
    savefig("C:\\Physik Uni\\julia_projects\\SU2\\hex_data\\auto_corr\\actions_beta_$β._N_t_$N_t._N_x_$N_x._epsilon_$ϵ.pdf")
    ...
    # display(image)
    # savefig("C:\\Physik Uni\\julia_projects\\SU2\\hex_data\\auto_corr\\auto_beta_$β._N_t_$N_t._N_x_$N_x._epsilon_$ϵ.pdf")
    ...
    writedlm("C:\\Physik Uni\\julia_projects\\SU2\\hex_data\\auto_corr\\actions_2_lex_beta_$β._N_t_$N_t._N_x_$N_x._epsilon_$ϵ.txt", actions_lex)
    writedlm("C:\\Physik Uni\\julia_projects\\SU2\\hex_data\\auto_corr\\actions_2_chess_beta_$β._N_t_$N_t._N_x_$N_x._epsilon_$ϵ.txt", actions_chess)
    writedlm("C:\\Physik Uni\\julia_projects\\SU2\\hex_data\\auto_corr\\actions_2_ran_beta_$β._N_t_$N_t._N_x_$N_x._epsilon_$ϵ.txt", actions_ran)

    # writedlm("C:\\Physik Uni\\julia_projects\\SU2\\hex_data\\auto_corr\\auto_lex_beta_$β._N_t_$N_t._N_x_$N_x._epsilon_$ϵ.txt", auto_lex)
    # writedlm("C:\\Physik Uni\\julia_projects\\SU2\\hex_data\\auto_corr\\auto_chess_beta_$β._N_t_$N_t._N_x_$N_x._epsilon_$ϵ.txt", auto_chess)
    # writedlm("C:\\Physik Uni\\julia_projects\\SU2\\hex_data\\auto_corr\\auto_ran_beta_$β._N_t_$N_t._N_x_$N_x._epsilon_$ϵ.txt", auto_ran)
end
=#
