...
base_path = "C:\\Users\\proue\\OneDrive\\Desktop\\Physik_Uni\\julia_projects\\U2_data\\square_data\\beta_$β\\N_t_$N_t.N_x_$N_x\\n_stout_$n_stout._rho_$ρ\\sim_count_$sim_count"
...
for β in [2.0,4.0,6.0,8.0]
    ...
    # base_base_path = "C:\\Users\\proue\\OneDrive\\Desktop\\Physik_Uni\\julia_projects\\SU2\\data\\square_data\\beta_$β\\N_t_$N_t.N_x_$N_x\\n_stout_$n_stout._rho_$ρ" 
    # base_path = string(base_base_path, "\\sim_count_$sim_count")
    base_path = "C:\\Users\\proue\\OneDrive\\Desktop\\Physik_Uni\\julia_projects\\U2_data\\hex_data\\beta_$β\\N_t_$N_t.N_x_$N_x\\n_stout_$n_stout._rho_$ρ\\sim_count_$sim_count"
    Q_path = string(base_path, "\\top_charge.txt")
...
let
    ...
    # println("Wilson gauge action smeareC: $s ± $s_sig")
    # println("Clover gauge action smeareC: $s_clo ± $s_clo_sig")
