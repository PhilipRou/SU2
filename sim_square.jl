...
# acceptances = readdlm("D:\\Physik Uni\\julia_projects\\SU2_data\\square_data\\N_t_32.N_x_32._beta_6.0\\n_stout_0._rho_0.12\\sim_count_1\\acceptances.txt")
...
# L = 16
    ...
    # mkpath("D:\\Physik Uni\\julia_projects\\SU2_data\\square_data\\auto_corr\\beta_$β")

    # writedlm("D:\\Physik Uni\\julia_projects\\SU2_data\\square_data\\auto_corr\\beta_$β\\eps_chess_$N_t._N_x_$N_x.txt", ϵ_chess_write)
    # writedlm("D:\\Physik Uni\\julia_projects\\SU2_data\\square_data\\auto_corr\\beta_$β\\eps_lex_$N_t._N_x_$N_x.txt", ϵ_lex_write)
    # writedlm("D:\\Physik Uni\\julia_projects\\SU2_data\\square_data\\auto_corr\\beta_$β\\eps_ran_$N_t._N_x_$N_x.txt", ϵ_ran_write)

    # writedlm("D:\\Physik Uni\\julia_projects\\SU2_data\\square_data\\auto_corr\\beta_$β\\actions_lex_N_t_$N_t._N_x_$N_x.txt", actions_lex)
    # writedlm("D:\\Physik Uni\\julia_projects\\SU2_data\\square_data\\auto_corr\\beta_$β\\actions_chess_N_t_$N_t._N_x_$N_x.txt", actions_chess)
    # writedlm("D:\\Physik Uni\\julia_projects\\SU2_data\\square_data\\auto_corr\\beta_$β\\actions_ran_N_t_$N_t._N_x_$N_x.txt", actions_ran)

    # writedlm("D:\\Physik Uni\\julia_projects\\SU2_data\\square_data\\auto_corr\\beta_$β\\acceptances_lex_N_t_$N_t._N_x_$N_x.txt", acceptances_lex)
    # writedlm("D:\\Physik Uni\\julia_projects\\SU2_data\\square_data\\auto_corr\\beta_$β\\acceptances_chess_N_t_$N_t._N_x_$N_x.txt", acceptances_chess)
    # writedlm("D:\\Physik Uni\\julia_projects\\SU2_data\\square_data\\auto_corr\\beta_$β\\acceptances_ran_N_t_$N_t._N_x_$N_x.txt", acceptances_ran)
